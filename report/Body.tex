...
The simplification algorithm is based on several atomic operations. The most important of them is an edge contraction. Let me denote an edge as a pair of vertices $(v_i, v_j)\longrightarrow\bar{v}$. The atomic opartion of a contraction is then defined as:
