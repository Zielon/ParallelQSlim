...
\emailSupervisor{michael.gerstmayr@navvis.com}
\date{\today}
%------------------------------
...
\begin{frame}
\frametitle{Algorithm Modifications}
\centering
How to target the simplification in a way to decimate most of planar surfaces?\\~\\
